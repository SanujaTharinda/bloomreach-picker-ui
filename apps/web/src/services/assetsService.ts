...
class AssetsService {
  ...
  private mapApiAssetDetailsToAsset(apiAssetDetails: ApiAssetDetails): Asset {
    return {
      ...
      fullUrl: apiAssetDetails.url, // BFF returns 'url', map to 'fullUrl'
      thumbnailUrl: apiAssetDetails.thumbnailUrl || '',
      previewUrl: apiAssetDetails.previewUrl,
      dimensions: apiAssetDetails.dimensions || { width: 0, height: 0 },
      ...
      width: apiAssetDetails.dimensions?.width || 0,
      height: apiAssetDetails.dimensions?.height || 0,
      size: apiAssetDetails.fileSize || 0,
